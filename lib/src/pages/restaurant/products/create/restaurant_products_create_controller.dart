...
class RestaurantProductsCreateController extends GetxController{
  ...
  void createProduct(BuildContext context)async{
    ...
    print('price: ${price}');
    print('id de la categoria: ${idCategory}');
  ...
  bool isValidForm(String name, String description, String price){
    ...
    if(idCategory.value==''){
      Get.snackbar('Formulario no validad', 'Debes seleccionar la categioria del producto ');
      return false;
    }
    if(imageFile1==null){
      Get.snackbar('Formulario no validad', 'Selecciona la imagen numero 1 del producto  ');
      return false;
    }
    if(imageFile2==null){
      Get.snackbar('Formulario no validad', 'Selecciona la imagen numero 2 del producto  ');
      return false;
    }
    if(imageFile3==null){
      Get.snackbar('Formulario no validad', 'Selecciona la imagen numero 3 del producto  ');
      return false;
    }
    return true;
  }
