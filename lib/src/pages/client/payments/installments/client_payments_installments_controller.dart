...
import 'package:proyecto/src/models/mercado_pago_payment.dart';
...
class ClientPaymentsInstallmentsController extends GetxController {
  ...
  List<MercadoPagoInstallment> installmentsList = <MercadoPagoInstallment>[]
      .obs;
  ...
  void createPayment() async {
    ...
    if (response.statusCode == 201) {
      ...
      Get.offNamedUntil(
          '/client/payments/status', (route) => false, arguments: {
  ...
  void badTokenProcess(String status,
    ...
    Map<String, String> badTokenErrorCodeMap = {
      ...
      '109': '${installments.paymentMethodId} no procesa pagos en ${this
          .installments.value} cuotas',
      '126': 'No pudimos procesar tu pago.',
      '129': '${installments
          .paymentMethodId} no procesa pagos del monto seleccionado.',
      '145': 'No pudimos procesar tu pago',
      '150': 'No puedes realizar pagos',
      '151': 'No puedes realizar pagos',
      '160': 'No pudimos procesar tu pago',
      '204': '${installments
          .paymentMethodId} no está disponible en este momento.',
